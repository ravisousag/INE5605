...
class ActivityService:
    ...
    def __init__(self, id_activity: int, desc_service: str, estimated_cost: float, real_cost: float, conc_date, jetski: Jetski, mechanics: Mechanic):
        ...
        if (isinstance(mechanics, Mechanic)):
